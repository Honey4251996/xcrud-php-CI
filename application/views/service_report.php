...
//	$serial_st = '';
//	$serial_end = '';
	global $service_id,$item_id,$start_d,$end_d,$customer_id;
	$service_id = 0;
	$item_id = 0;
	$start_d = 0;
	$end_d = 0;
	$customer_id = 0;
	$query = array("report"=>"service");
    ...
    <div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="row">
					<div class="panel panel-default">
						<form class="form panel-body filter-form">
							<div class="row">
								<?php echo filter_widgets::service($service_id); ?>
								<?php echo filter_widgets::item($item_id); ?>
								...
								<div class="col-sm-12">
									...
									<a href="service_report" class="btn btn-default submit-report pull-right" style="margin-bottom: 0">Reset</a>
								</div>
				...
				<div class="row">
					<?php echo $report->service_report($start_d, $end_d, $customer_id,$service_id,$item_id)->render(); ?>
				</div>
