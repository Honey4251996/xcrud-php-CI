<?php
	$action_data = get_collection_info($action_id);
	...
	$remaining = $action["total"];
	foreach($payment as $payment_line){
		$remaining -= $payment_line['paid'];
	}
...
<div id="receipt">
	...
	<?php echo $separator ?>
	<div class="line"><b>Date/Time:&nbsp<?php echo date("d-M-y / h:i:s A",$date); ?> </b></div>
	...
	<?php echo $separator ?>
	<div class="line text-center" style="font-size:16px;"><b>Collected items</b></div>
	<?php echo $separator ?>
<?php foreach ($action_lines as $line): ?>
	...
	<div class="line" style="font-size:14px;">
		...
		<div class="col-qty text-right"><b><?php echo $line['action_quantity']." ".item_unit($line['item_id']); ?></b></div>
		<div class="col-price text-right"><b><?php echo "BD ".$line['price'] ?></b></div>
		<div class="clearfix"></div>
	</div>
	<div class="line">
		<?php if($line['discount'] > 0): ?>
		<div class="pull-left"><b><?php echo "Disc: ".number_format($line['discount'],2)."%" ?></b></div>
		<?php endif; ?>
