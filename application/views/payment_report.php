...
//	$serial_st = '';
//	$serial_end = '';
	global $start_d,$end_d,$customer_id;
	$start_d = 0;
	$end_d = 0;
	$customer_id = 0;
	$query = array("report"=>"payment");
    ...
    <div class="container body">
		<div class="main_container">
			...
			<div class="right_col" role="main">
						...
						<form class="form panel-body filter-form">
							<div class="row">
								...
								<div class="col-sm-12">
									...
									<a href="payment_report" class="btn btn-default submit-report pull-right" style="margin-bottom: 0">Reset</a>
								</div>
				...
				<div class="row">
					<?php echo $report->payment_report($start_d, $end_d, $customer_id)->render(); ?>
				</div>
