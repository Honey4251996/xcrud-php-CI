...
class Xcrud_config
{
    ...
    // theme and language
    public static $theme = 'scrum'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
    ...
    // session
    public static $sess_name = PRODUCT_ID; // If your script is already using the session, specify the session name for it. By default, the name of the session in PHP equal 'PHPSESSID'.
    ...
    // editor
   // public static $editor_url = 'plugins/editors/tinymce/tinymce.min.js'; // URL path to editor script, if you want to use the visual editor.
    public static $editor_url = 'assets/plugins/editors/ckeditor/ckeditor.js';
    ...
    public static $limit_list = array('5','10','25', '50', '100', 'all'); // default limits list
    ...
    public static $showseconds = true; // jqueryui time format
    ...
    // map
    public static $default_point = '26.14900850385594, 50.53648160371097';
    public static $default_text = 'your_position';
    public static $default_zoom = 10;
    public static $default_width = '';
    ...
    // xcrud folder url
    public static $scripts_url = PRODUCT_URL."/application"; // URL to the xCRUD folder, not real path, without a trailing slash, can be relative, e.g. 'some_folder/xcrud' or absolute, e.g. 'http://www.your_site.com/some_folder/xcrud'. If empty - will be detected automatically
    ...
    public static $plugins_uri = '../assets/plugins/xcrud/plugins'; // scripts and libraries
    public static $themes_uri = '../assets/plugins/xcrud/themes'; // css, images
    public static $lang_uri = '../assets/plugins/xcrud/languages'; // js files
